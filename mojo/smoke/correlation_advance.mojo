...
def main() raises:
    ...
    var root_output = result_message("source", "parent", "source", "advance-ok-request", "{\"value\":1,\"noise\":2,\"reactions\":[{\"kind\":\"accepted\"},{\"kind\":\"rejected\"}]}", "ok", contract.id, contract.version)
