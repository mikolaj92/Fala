...
def main() raises:
    ...
    var homeostat_reopen = dispatch_native_command("homeostat reopen --db " + path + " --run-id cli-run --homeostat-id homeostat-demo --process-id process-demo --now 2026-01-01T00:00:06Z")
