...
def _manifest(adapter: String) raises -> String:
    return "{\"id\":\"pkg\",\"version\":\"1\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":" + adapter + "}]}]}"
...
def main() raises:
    ...
    _write(valid, "{\"id\":\"pkg\",\"version\":\"1\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"config\":[],\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    _expect_error(valid, "manifest.type at /correlation_paths/0/effectors/0/config: expected object")
    _write(valid, "{\"id\":\"pkg\",\"version\":\"1\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"retry_policy\":\"none\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"version\":\"1\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"retry_policy\":\"sometimes\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    _expect_error(valid, "expected automatic or none")

    # Conditional conduction is strict, direct-upstream-only, and canonical.
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"source\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}},{\"id\":\"merge\",\"conduction\":[\"source\"],\"when\":{\"upstream\":\"source\",\"path\":\"decision.verdict\",\"equals\":\"approve\"},\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"source\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}},{\"id\":\"merge\",\"when\":{\"upstream\":\"source\",\"path\":\"verdict\",\"equals\":\"approve\"},\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    _expect_error(valid, "condition upstream must be a direct conduction dependency")
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"source\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}},{\"id\":\"merge\",\"conduction\":[\"source\"],\"when\":{\"upstream\":\"source\",\"path\":\"verdict\",\"equals\":[]},\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"version\":\"1\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":[]}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"version\":\"1\",\"extra\":true,\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    _expect_error(valid, "manifest.unknown at /extra: unknown field")
    _write(valid, "{\"id\":\"pkg\",\"version\":\"1\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}},{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    _expect_error(valid, "manifest.duplicate at /correlation_paths/0/effectors/1/id: duplicate effector id")
    _write(valid, "{\"id\":\"pkg\",\"version\":\"1\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]},{\"id\":\"path\",\"effectors\":[{\"id\":\"other\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    _expect_error(valid, "manifest.duplicate at /correlation_paths/1/id: duplicate correlation path id")
    _write(valid, "{\"id\":\"pkg\",\"version\":\"1\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\",\"unknown\":true}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"runtime\":{\"backend\":{\"kind\":\"sqlite\",\"path\":\"state.sqlite\"},\"reaction_store\":{\"kind\":\"memory\",\"root\":\"reactions\"}},\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    _expect_error(valid, "manifest.unsupported at /runtime/reaction_store/kind: unsupported reaction store kind")
    _write(valid, "{\"id\":\"pkg\",\"runtime\":{\"backend\":{\"kind\":\"sqlite\",\"path\":\"state.sqlite\"},\"reaction_store\":{\"kind\":\"filesystem\"}},\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"impulse_types\":[{\"id\":\"input\"}],\"impulse_relations\":[{\"id\":\"derived\",\"source_impulse_types\":[\"missing\"],\"target_impulse_types\":[\"input\"]}],\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"impulse_types\":[{\"id\":\"input\"}],\"capabilities\":[{\"id\":\"cap\",\"accepts_impulse_types\":[\"missing\"]}],\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"capability\":\"cap\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"root\",\"conduction\":[\"leaf\"],\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}},{\"id\":\"leaf\",\"conduction\":[\"root\"],\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"timeout_seconds\":0,\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"subprocess\",\"command\":[\"echo\",\"ok\"],\"cwd\":\"work\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"input_schema\":{\"type\":\"object\",\"required\":[\"ticket\"]},\"terminals\":[{\"id\":\"done\",\"source_effector\":\"eff\",\"status\":\"succeeded\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}}}],\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"correlation_paths\":[{\"id\":\"path\",\"terminals\":[{\"id\":\"done\",\"source_effector\":\"missing\",\"status\":\"succeeded\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}}}],\"effectors\":[{\"id\":\"eff\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"path_templates\":[{\"id\":\"slot\",\"parameters\":{\"index\":\"integer\",\"name\":\"string\"},\"effectors\":[{\"id\":\"prepare_${index}\",\"config\":{\"name\":\"${name}\"},\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}},{\"id\":\"finish_${index}\",\"conduction\":[\"prepare_${index}\"],\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}],\"correlation_paths\":[{\"id\":\"slots\",\"prefix_effectors\":[{\"id\":\"begin\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}],\"expansion\":{\"template\":\"slot\",\"max_items\":3,\"serial\":true,\"items\":[{\"index\":0,\"name\":\"alpha\"},{\"index\":1,\"name\":\"beta\"}]},\"suffix_effectors\":[{\"id\":\"end\",\"conduction\":[\"finish_1\"],\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}]}")
    ...
    _write(valid, "{\"id\":\"pkg\",\"path_templates\":[{\"id\":\"slot\",\"parameters\":{\"index\":\"integer\"},\"effectors\":[{\"id\":\"slot_${index}\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}],\"correlation_paths\":[{\"id\":\"slots\",\"expansion\":{\"template\":\"slot\",\"max_items\":1,\"items\":[{\"index\":0},{\"index\":1}]}}]}")
    _expect_error(valid, "manifest.limit at /correlation_paths/0/expansion/items: item count exceeds max_items")
    _write(valid, "{\"id\":\"pkg\",\"path_templates\":[{\"id\":\"slot\",\"parameters\":{\"index\":\"integer\"},\"effectors\":[{\"id\":\"slot_${index}\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}],\"correlation_paths\":[{\"id\":\"slots\",\"expansion\":{\"template\":\"slot\",\"max_items\":1,\"items\":[{}]}}]}")
    _expect_error(valid, "manifest.missing at /correlation_paths/0/expansion/items/0/index")
    _write(valid, "{\"id\":\"pkg\",\"path_templates\":[{\"id\":\"slot\",\"parameters\":{\"index\":\"integer\"},\"effectors\":[{\"id\":\"slot_${index}\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}],\"correlation_paths\":[{\"id\":\"slots\",\"expansion\":{\"template\":\"slot\",\"max_items\":1,\"items\":[{\"index\":\"wrong\"}]}}]}")
    _expect_error(valid, "manifest.type at /correlation_paths/0/expansion/items/0/index: expected integer")
    _write(valid, "{\"id\":\"pkg\",\"path_templates\":[{\"id\":\"slot\",\"parameters\":{\"index\":\"integer\"},\"effectors\":[{\"id\":\"same\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}],\"correlation_paths\":[{\"id\":\"slots\",\"expansion\":{\"template\":\"slot\",\"max_items\":2,\"items\":[{\"index\":0},{\"index\":1}]}}]}")
    _expect_error(valid, "manifest.duplicate at /correlation_paths/0/effectors/1/id: duplicate effector id")
    _write(valid, "{\"id\":\"pkg\",\"path_templates\":[{\"id\":\"slot\",\"parameters\":{\"index\":\"integer\"},\"effectors\":[{\"id\":\"slot_${missing}\",\"output_schema\":{\"type\":\"object\",\"required\":[\"ok\"],\"properties\":{\"ok\":{\"type\":\"boolean\"}}},\"adapter\":{\"kind\":\"manual_homeostat\"}}]}],\"correlation_paths\":[{\"id\":\"slots\",\"expansion\":{\"template\":\"slot\",\"max_items\":1,\"items\":[{\"index\":0}]}}]}")
