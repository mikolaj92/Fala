...
| SQLite backend | PARTIAL | Reference backend exists with append-only commands/events, carriers, processes, gates, projections, artifacts, bridge inbox/outbox, schema tracking, and run-scoped writes reject unknown runs. Further hardening can continue around broader replay guarantees. |
