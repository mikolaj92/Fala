...
| SQLite backend | PARTIAL | Reference backend exists with append-only commands/events, carriers, processes, gates, projections, artifacts, bridge inbox/outbox, schema tracking, and command submission rejects non-create commands for unknown runs. Further hardening can continue around broader replay guarantees. |
